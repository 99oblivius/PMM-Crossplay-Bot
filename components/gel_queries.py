...
# WITH:
#     $ gel-py --tls-security insecure --target async --dir queries --file /srv/ValorsLeague/Database/tools/../../crossplay/crossplaybot/components/queries.py
...
async def disable_map(
    executor: gel.AsyncIOExecutor,
    *,
    guild_id: Snowflake,
    name: str,
) -> DisableMapResult | None:
